...
The architecture consists of data ingestion, detection processing, alerting, backend services, database storage, and a frontend dashboard.
...
This flow represents the logical architecture of the NSD system.
...
This represents a generic deployment model before cloud-specific implementation.
...
## Production Architecture (Cloudflare + AWS)

NSD production environment is designed using Cloudflare and AWS.

Cloudflare is used for edge security and access control, and AWS hosts the core application services.
...
flowchart TB
    User[Users / Admin]
    Device[IoT Devices / GPS / Sensors]
    Email[Alert Email]
